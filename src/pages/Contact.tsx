            ...
            <div className="container-wide">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-muted-foreground">
                  If you would like to learn more about the CyberQuest project, collaborate with
                  us, or explore educational opportunities, please contact:
                </p>
              </div>
              ...
              <div className="mx-auto mt-10 max-w-2xl rounded-xl border border-border bg-card p-6 text-center shadow-soft">
                ...
                <p className="mt-4 text-sm text-muted-foreground">
                  We are also requesting a dedicated project email address and will update this
                  page once it is available.
                </p>
              </div>
            </div>
          </section>
