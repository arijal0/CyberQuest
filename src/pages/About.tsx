        ...
        <section className="section-padding bg-muted/30">
          <div className="container-wide">
            <div className="mx-auto max-w-3xl space-y-4 text-lg text-muted-foreground">
              ...
              <p>
                Cybersecurity is a rapidly growing field with increasing demand for a skilled and
                diverse workforce. As cyber threats continue to evolve, there is a critical need for
                educational programs that combine strong academic foundations with real-world
                experience.
              </p>
              <p>
