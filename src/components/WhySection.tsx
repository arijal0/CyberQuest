import { AlertTriangle, TrendingUp, Shield, Target, Briefcase, GraduationCap, Users } from "lucide-react";
      ...
      <div className="container-wide">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            The cybersecurity landscape presents pressing challenges that demand innovative educational responses.
          </p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {solutions.map((solution, index) => (
            <div
              key={index}
              className="group rounded-xl border border-border bg-card p-6 shadow-soft transition-all duration-300 hover:shadow-soft-lg hover:border-accent/30"
            >
